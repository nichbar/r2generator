...
import shadow.bundletool.com.android.tools.r8.naming.MemberNaming.MethodSignature.initializer
...
class FinalRClassBuilder(
    ...
    fun build(): JavaFile {
        ...
        return JavaFile.builder(packageName, result.build())
                .addFileComment("Generated code from R2 Generator gradle plugin. Do not modify!")
                .build()
    }
